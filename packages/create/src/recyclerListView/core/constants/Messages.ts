export const Messages: { [key: string]: string } = {
    ...
    WARN_NO_DATA:
        'You have mounted RecyclerListView with an empty data provider (Size in 0). Please mount only if there is atleast one item ' +
        'to ensure optimal performance and to avoid unexpected behavior',
    VISIBLE_INDEXES_CHANGED_DEPRECATED:
        'onVisibleIndexesChanged deprecated. Please use onVisibleIndicesChanged instead.',
};
