...
import { getX, getH } from '@lightningjs/ui-components/utils';
...
export default class Row extends FocusManager {
    ...
    _isOnScreen(child) {
        ...
        const ItemX = this.core.renderContext.px + this.Items.transition('x').targetValue + x;
        const { w } = child;
        ...
        const withinRightStageBounds = ItemX + w < this.stage.w / this.stage.getRenderPrecision();
