...
export interface RecyclerChild extends React.ReactElement<RecyclerListViewProps> {
    ref: (recyclerRef: any) => Record<string, unknown>;
...
export default class StickyContainer<P extends StickyContainerProps> extends ComponentCompat<P> {
        ...
        return (
            <View style={this.props.style ? this.props.style : { flex: 1 }}>
                ...
                {this.props.stickyHeaderIndices ? (
                    <StickyHeader
                        ref={(stickyHeaderRef: any) => this._getStickyHeaderRef(stickyHeaderRef)}
                ...
                {this.props.stickyFooterIndices ? (
                    <StickyFooter
                        ref={(stickyFooterRef: any) => this._getStickyFooterRef(stickyFooterRef)}
    ...
    private _rlvRowRenderer = (
        ...
        if (this.props.alwaysStickyFooter) {
            ...
            if (!isScrollable && this.props.stickyFooterIndices && index === this.props.stickyFooterIndices[0]) {
                return null;
            }
        }
