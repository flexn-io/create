        ...
        <Screen style={theme.styles.screen} focusOptions={{ verticalWindowAlignment: 'both-edge' }}>
            ...
            >
                ...
                <Text
                    ...
                    {...testProps('template-home-screen-platform-text')}
                >{`platform: ${Api.platform}`}</Text>
                <Text
                    style={theme.styles.textH3}
                    {...testProps('template-home-screen-factor-text')}
                >{`factor: ${Api.formFactor}`}</Text>
                <Text
                    style={theme.styles.textH3}
                    {...testProps('template-home-screen-engine-text')}
                >{`engine: ${Api.engine}`}</Text>
                <TouchableOpacity
                    onPress={toggle}
                    onFocus={() => {
