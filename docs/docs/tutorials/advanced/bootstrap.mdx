...
In this tutorial we will not start completely from scratch as the aim is to explain our process of creating Flexn template and also showcase the befits of using Flexn Create SDK.
